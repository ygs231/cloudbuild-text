...
var (
	...
	remoteInstanceName  = flag.String("remote_instance_name", "", "The remote_instance_name for caching snapshots and interacting with the CAS if an file digest is specified")
	...
	actionDigest        = flag.String("action_digest", "", "The optional digest of the file you want to mount.")
)
...
func main() {
	...
	*log.IncludeShortFileName = true
	...
	if *actionDigest != "" {
		...
		if err != nil {
			log.Fatalf("Error parsing file digest %q: %s", *actionDigest, err)
		}
