...
import (
	...
	hlpb "github.com/ninja-cloudbuild/cloudbuild/proto/health"
...
// computed by the execution invocation.
...
// cross machine) processes. This may be implemented by a cloud-pubsub invocation,
...
type Checker interface {
	...
	// indicate to the health checker that this invocation is unhealthy and
...
// invocation) that manages keys that can be fetched and used to encrypt/decrypt
// data.
type KMS interface {
