...
import (
	...
	flagyaml "github.com/ninja-cloudbuild/cloudbuild/server/util/flagutil/yaml"
)

const pathFlagName = "config_file"

var configPath = flag.String(pathFlagName, "/IdeaProjects/cloudbuild-main/config/buildbuddy.local.yaml", "The path to a buildbuddy config file")
