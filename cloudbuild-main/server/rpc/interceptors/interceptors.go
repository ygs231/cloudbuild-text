...
import (
	...
	"github.com/ninja-cloudbuild/cloudbuild/server/util/quota"
	...
	bblog "github.com/ninja-cloudbuild/cloudbuild/server/util/log"
	requestcontext "github.com/ninja-cloudbuild/cloudbuild/server/util/request_context"
)

const (
	buildBuddyServicePrefix = "/buildbuddy.invocation.BuildBuddyService/"
)
