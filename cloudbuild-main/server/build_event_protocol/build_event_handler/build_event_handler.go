...
import (
	...
	"github.com/ninja-cloudbuild/cloudbuild/proto/build_event_stream"
	"github.com/ninja-cloudbuild/cloudbuild/proto/command_line"
	"github.com/ninja-cloudbuild/cloudbuild/proto/resource"
	"github.com/ninja-cloudbuild/cloudbuild/server/build_event_protocol/accumulator"
	"github.com/ninja-cloudbuild/cloudbuild/server/build_event_protocol/build_status_reporter"
	"github.com/ninja-cloudbuild/cloudbuild/server/build_event_protocol/invocation_format"
	"github.com/ninja-cloudbuild/cloudbuild/server/build_event_protocol/target_tracker"
	...
	"github.com/ninja-cloudbuild/cloudbuild/server/olapdbconfig"
	"github.com/ninja-cloudbuild/cloudbuild/server/remote_cache/hit_tracker"
	"github.com/ninja-cloudbuild/cloudbuild/server/remote_cache/scorecard"
	...
	"github.com/ninja-cloudbuild/cloudbuild/server/util/paging"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/perms"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/protofile"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/redact"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/status"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/terminal"
	"github.com/ninja-cloudbuild/cloudbuild/server/util/uuid"
	"github.com/prometheus/client_golang/prometheus"
	"golang.org/x/sync/errgroup"
	"google.golang.org/protobuf/proto"
	"google.golang.org/protobuf/types/known/fieldmaskpb"

	//apipb "github.com/ninja-cloudbuild/cloudbuild/proto/api/v1"
	aaipb "github.com/ninja-cloudbuild/cloudbuild/proto/api/v1/action"
	bepb "github.com/ninja-cloudbuild/cloudbuild/proto/build_events"
	capb "github.com/ninja-cloudbuild/cloudbuild/proto/cache"
	...
	sipb "github.com/ninja-cloudbuild/cloudbuild/proto/stored_invocation"
	...
	if e.isFirstEventWithOptions(&bazelBuildEvent) {
		...
		if *enableChunkedEventLogs {
			...
			if numLinesToRetain != 0 {
				...
				// 1 for the progress tracker, 1 for each file, and 2 blank lines.
...
func (e *EventChannel) collectAPIFacets(iid string, event *build_event_stream.BuildEvent) error {
	...
	if action != nil {
		...
		// early exit if this isn't an file event.
		return nil
	}
