...
func (h *HitTracker) recordDetailedStats(d *repb.Digest, stats *detailedStats) error {
	...
	// Target/file mnemonic metadata is not expected for BES uploads, but
	// otherwise this metadata is expected if file ID is present.
