...
import (
	...
	smpb "github.com/ninja-cloudbuild/cloudbuild/proto/semver"
...
func (s *CapabilitiesServer) actionCacheUpdateEnabled(ctx context.Context) bool {
	...
	// file cache write capabilities. This way, the client knows to avoid
	...
	// file cache server when the update is actually attempted.
