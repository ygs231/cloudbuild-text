...
func (s *ActionCacheServer) GetActionResult(ctx context.Context, req *repb.GetActionResultRequest) (*repb.ActionResult, error) {
	...
	// Fetch the "ActionResult" object which enumerates all the files in the file.
...
// file, and to assist with client debugging, the client MUST first upload
...
//     file result, such as a missing command or file.
