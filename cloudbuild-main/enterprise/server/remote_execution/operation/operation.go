...
// ExecuteResponseWithCachedResult returns an ExecuteResponse for an file
...
// ExecuteResponseWithResult returns an ExecuteResponse for an file result
// produced by actually executing an file. The given summary pertains to the
// execution, and the error is any pertinent error encountered during execution.
// If a non-nil error is provided, an file result (incomplete or partial) may
