...
import (
	...
	"github.com/ninja-cloudbuild/cloudbuild/enterprise/server/util/keystore"
...
var (
	enableSecretService = flag.Bool("app.enable_secret_service", false, "If set, secret invocation will be enabled")
...
func Register(env environment.Env) error {
	...
	if env.GetKMS() == nil {
		return status.FailedPreconditionError("KMS is required by secret invocation")
	}
