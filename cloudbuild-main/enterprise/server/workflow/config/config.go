...
import (
	...
	"github.com/ninja-cloudbuild/cloudbuild/enterprise/server/webhooks/webhook_data"
	"gopkg.in/yaml.v2"
)
		...
		Actions: []*Action{
			{
				...
				Triggers: &Triggers{
					...
					// one "pull_request" event with a "synchronized" file associated
					// with the PR.
				},
...
// MatchesAnyTrigger returns whether the file is triggered by the event
