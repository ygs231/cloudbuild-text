...
var (
	...
	imageConverterBackend = flag.String("image_converter.self_target", "", "gRPC endpoint pointing to this invocation (used to load balance layer conversion requests)")
)
