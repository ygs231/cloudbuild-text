...
const (
	...
	// VMExecPort is the guest gRPC port for the Exec invocation used to execute commands on the guest.
	VMExecPort = 25415
	// VMVFSPort is the guest gRPC port for the FileSystem invocation used to configure the FUSE-based filesystem.
	VMVFSPort = 25416
