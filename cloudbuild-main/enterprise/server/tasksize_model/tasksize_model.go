...
var (
	...
	servingAddress     = flag.String("remote_execution.task_size_model.serving_address", "", "gRPC address pointing to TensorFlow Serving prediction invocation with task size models (cpu, mem).")
)
